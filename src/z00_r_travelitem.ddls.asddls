...
define  view entity Z00_R_TRAVELITEM
  ...
  association to parent Z00_R_TRAVEL as _Travel on
    $projection.AgencyId = _Travel.AgencyId and
    $projection.TravelId = _Travel.TravelId
  association [0..1] to Z00_E_TravelItem as _Extension on
     $projection.ItemUuid = _Extension.ItemUuid
